...
const sanitizeProps = props => {
  ...
  return {
    ...
    reverseEdgeAnimationDirection:
      props.reverseEdgeAnimationDirection !== undefined
        ? props.reverseEdgeAnimationDirection
        : true,
    timeout: timeout,
    ...
    navButtonsAlwaysInvisible:
      props.navButtonsAlwaysInvisible !== undefined ? props.navButtonsAlwaysInvisible : false,
    navButtonsAlwaysVisible:
      props.navButtonsAlwaysVisible !== undefined ? props.navButtonsAlwaysVisible : false,
...
class Carousel extends Component {
  ...
  render() {
    ...
    const buttonCssClassValue = `${classes.button} ${buttonVisibilityClassValue} ${
